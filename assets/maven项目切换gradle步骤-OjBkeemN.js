import{a as e,c as t,i as n,t as r}from"./app-DKOm73pV.js";var i=JSON.parse(`{"path":"/build/maven%E9%A1%B9%E7%9B%AE%E5%88%87%E6%8D%A2gradle%E6%AD%A5%E9%AA%A4.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1752830021000,"contributors":[{"name":"oycm","username":"oycm","email":"1164864987@qq.com","commits":1,"url":"https://github.com/oycm"},{"name":"ouyangcm","username":"ouyangcm","email":"mingorg@163.com","commits":1,"url":"https://github.com/ouyangcm"}],"changelog":[{"hash":"9113c07732e36a1d1300961f5feda15e1040d133","time":1752830021000,"email":"mingorg@163.com","author":"ouyangcm","message":"maven切换gradle注意补充"},{"hash":"a7fdd1819c8f6e2fa305fdfd8e79876be94e2b9b","time":1736747719000,"email":"1164864987@qq.com","author":"oycm","message":"maven切换gradle"}]},"filePathRelative":"build/maven项目切换gradle步骤.md"}`),a={name:`maven项目切换gradle步骤.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h2 id="maven切换gradle" tabindex="-1"><a class="header-anchor" href="#maven切换gradle"><span>Maven切换Gradle</span></a></h2><p>SpringBoot版本：1.5.7.RELEASE；</p><p>gradle版本：4.9</p><p>在 <code>maven</code> 项目中使用 <code>gradle init</code> 命令初始化项目，发现 <code>maven</code> 文件时会提示是否依据此配置构建，选中。</p><p><strong>构建项目时，注意项目设置 gradle 使用的 java 版本。</strong></p><h3 id="gradle-init-d配置" tabindex="-1"><a class="header-anchor" href="#gradle-init-d配置"><span>gradle-init.d配置</span></a></h3><p>配置maven仓库和插件的仓库。</p><p>gradle的目录或gradle wrapper下载的init.d目录下init.gradle文件内容：</p><div class="language-gradle line-numbers-mode" data-highlighter="prismjs" data-ext="gradle"><pre><code class="language-gradle"><span class="line">allprojects<span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="项目文件" tabindex="-1"><a class="header-anchor" href="#项目文件"><span>项目文件</span></a></h3><p>maven配置</p><div class="language-pom line-numbers-mode" data-highlighter="prismjs" data-ext="pom"><pre><code class="language-pom"><span class="line">&lt;parent&gt;</span>
...
<span class="line">&lt;/dependencyManagement&gt;</span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>构建文件build.gradle</p><div class="language-gradle line-numbers-mode" data-highlighter="prismjs" data-ext="gradle"><pre><code class="language-gradle"><span class="line"><span class="token comment">// 声明Gradle使用的插件</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>setting.gradle</strong></p><div class="language-gradle" data-highlighter="prismjs" data-ext="gradle"><pre><code class="language-gradle"><span class="line">rootProject<span class="token punctuation">.</span>name <span class="token operator">=</span> <span class="token string">&#39;gradle-project&#39;</span> <span class="token comment">// 设置根项目的名称</span></span>
<span class="line"></span>
