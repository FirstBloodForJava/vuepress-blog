import{a as e,c as t,i as n,t as r}from"./app-B8OsJqUb.js";var i=JSON.parse(`{"path":"/linux/shell%E8%AF%AD%E6%B3%95.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1730110603000,"contributors":[{"name":"oycm","username":"oycm","email":"1164864987@qq.com","commits":1,"url":"https://github.com/oycm"}],"changelog":[{"hash":"5a3c760801ec6a8e4f309abfd37f1f9ed5d9959a","time":1730110603000,"email":"1164864987@qq.com","author":"oycm","message":"增加linux内容"}]},"filePathRelative":"linux/shell语法.md"}`),a={name:`shell语法.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h2 id="shell脚本介绍" tabindex="-1"><a class="header-anchor" href="#shell脚本介绍"><span>shell脚本介绍</span></a></h2><p>脚本：脚本是一个文本文件，包含了一系列要执行的命令和控制结构（如条件语句和循环）</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token shebang important">#!/bin/bash</span></span>
