import{_ as s,c as a,b as e,o as t}from"./app-YadWlgJG.js";const p={};function i(l,n){return t(),a("div",null,n[0]||(n[0]=[e(`<h2 id="maven切换gradle" tabindex="-1"><a class="header-anchor" href="#maven切换gradle"><span>Maven切换Gradle</span></a></h2><p>SpringBoot版本：1.5.7.RELEASE；</p><p>gradle版本：4.9</p><h3 id="gradle-init-d配置" tabindex="-1"><a class="header-anchor" href="#gradle-init-d配置"><span>gradle-init.d配置</span></a></h3><p>配置maven仓库和插件的仓库。</p><p>gradle的目录或gradle wrapper下载的init.d目录下init.gradle文件内容：</p><div class="language-gradle line-numbers-mode" data-highlighter="prismjs" data-ext="gradle" data-title="gradle"><pre><code><span class="line">allprojects<span class="token punctuation">{</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,24)]))}const c=s(p,[["render",i],["__file","maven项目切换gradle步骤.html.vue"]]),r=JSON.parse('{"path":"/build/maven%E9%A1%B9%E7%9B%AE%E5%88%87%E6%8D%A2gradle%E6%AD%A5%E9%AA%A4.html","title":"","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"Maven切换Gradle","slug":"maven切换gradle","link":"#maven切换gradle","children":[{"level":3,"title":"gradle-init.d配置","slug":"gradle-init-d配置","link":"#gradle-init-d配置","children":[]},{"level":3,"title":"项目文件","slug":"项目文件","link":"#项目文件","children":[]},{"level":3,"title":"加载步骤","slug":"加载步骤","link":"#加载步骤","children":[]},{"level":3,"title":"maven多模块","slug":"maven多模块","link":"#maven多模块","children":[]}]}],"git":{"updatedTime":1736747719000,"contributors":[{"name":"oycm","username":"oycm","email":"1164864987@qq.com","commits":1,"url":"https://github.com/oycm"}]},"filePathRelative":"build/maven项目切换gradle步骤.md"}');export{c as comp,r as data};
