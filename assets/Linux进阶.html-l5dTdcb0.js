import{_ as a,c as n,e,o as p}from"./app-BmLfP4d8.js";const l={};function t(i,s){return p(),n("div",null,s[0]||(s[0]=[e(`<h1 id="linux进阶" tabindex="-1"><a class="header-anchor" href="#linux进阶"><span>Linux进阶</span></a></h1><h2 id="oomkiller事件" tabindex="-1"><a class="header-anchor" href="#oomkiller事件"><span>OOMkiller事件</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># /var/log/messages或/var/log/syslog日志</span></span>
