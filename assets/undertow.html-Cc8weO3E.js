...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>处理http请求的要求：</p>`,7)]))}const r=s(l,[["render",i],["__file","undertow.html.vue"]]),c=JSON.parse('{"path":"/spring/undertow.html","title":"undertow","lang":"zh-CN","frontmatter":{},"headers":[],"git":{"updatedTime":1734324260000,"contributors":[{"name":"ouyangcm","username":"ouyangcm","email":"mingorg@163.com","commits":2,"url":"https://github.com/ouyangcm"}]},"filePathRelative":"spring/undertow.md"}');export{r as comp,c as data};
