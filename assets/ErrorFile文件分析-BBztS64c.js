import{a as e,c as t,i as n,t as r}from"./app-DKOm73pV.js";var i=JSON.parse(`{"path":"/JVM/ErrorFile%E6%96%87%E4%BB%B6%E5%88%86%E6%9E%90.html","title":"ErrorFile分析","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1747904581000,"contributors":[{"name":"ouyangcm","username":"ouyangcm","email":"mingorg@163.com","commits":2,"url":"https://github.com/ouyangcm"}],"changelog":[{"hash":"523c25601d44b41d3c43449c16789193aa4b8ecc","time":1747904581000,"email":"mingorg@163.com","author":"ouyangcm","message":"Java程序崩溃日志文件分析"},{"hash":"be51c0d892bedfc7c45fee34070396e771135dfc","time":1747820129000,"email":"mingorg@163.com","author":"ouyangcm","message":"Java程序奔溃文件分析"}]},"filePathRelative":"JVM/ErrorFile文件分析.md"}`),a={name:`ErrorFile文件分析.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h1 id="errorfile分析" tabindex="-1"><a class="header-anchor" href="#errorfile分析"><span>ErrorFile分析</span></a></h1><p>现在分析工具：https://fastthread.io/</p><figure><img src="http://47.101.155.205/image-20250521172318096.png" alt="image-20250521172318096" tabindex="0" loading="lazy"><figcaption>image-20250521172318096</figcaption></figure><p><strong>启用了CompressedOops，Java堆被放在低地址空间，可能阻碍native memory（如mmap、Metaspace）增长，从而导致本地内存分配失败 → 崩溃。</strong></p><p><strong>GC内存字段含义：</strong></p><ul><li>used：实际使用的内存。</li><li>capacity：JVM内部已经分配好、可立即使用但尚未使用的空间。</li><li>committed：操作系统已承诺的物理内存页。JVM向操作系统实际申请的内存大小。</li><li>reserved：JVM为该块预留的最大虚拟地址空间。</li></ul><figure><img src="http://47.101.155.205/image-20250522164911113.png" alt="image-20250522164911113" tabindex="0" loading="lazy"><figcaption>image-20250522164911113</figcaption></figure><figure><img src="http://47.101.155.205/image-20250522165245825.png" alt="image-20250522165245825" tabindex="0" loading="lazy"><figcaption>image-20250522165245825</figcaption></figure><p><strong>可以给应用开启预分配内存，避免这种情况的内存不够，导致应用停止的情况。</strong></p><figure><img src="http://47.101.155.205/image-20250522165955616.png" alt="image-20250522165955616" tabindex="0" loading="lazy"><figcaption>image-20250522165955616</figcaption></figure><div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre><code class="language-markdown"><span class="line">#</span>
