import{a as e,c as t,i as n,t as r}from"./app-DKOm73pV.js";var i=JSON.parse(`{"path":"/nginx/nginx.html","title":"nginx","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1746853414000,"contributors":[{"name":"oycm","username":"oycm","email":"1164864987@qq.com","commits":1,"url":"https://github.com/oycm"}],"changelog":[{"hash":"5589c5c5005a10a74929b167e371865750a04c7f","time":1746853414000,"email":"1164864987@qq.com","author":"oycm","message":"nginx"}]},"filePathRelative":"nginx/nginx.md"}`),a={name:`nginx.md`};function o(r,i,a,o,s,c){return t(),n(`div`,null,[...i[0]||=[e(`<h1 id="nginx" tabindex="-1"><a class="header-anchor" href="#nginx"><span>nginx</span></a></h1><h2 id="_1-什么是nginx-做什么" tabindex="-1"><a class="header-anchor" href="#_1-什么是nginx-做什么"><span>1.什么是nginx，做什么</span></a></h2><p>Nginx是一款轻量级的Web服务/反向代理服务器及电子邮件(IMAP/POP3)代理服务器，其特点是占用内存少，并发能力强，简单的配置文件。</p><p><code>反向代理</code>：反向代理服务器位于用户与目标服务器之间，但是对于用户而言，反向代理服务器就相当于目标服务器，即用户直接访问反向代理服务器就可以访问目标服务器的资源。同时用户不需要知道目标代理服务器的地址，也无需在用户端做任何设定。反向代理服务器通常用来作为Web加速，即用反向代理作为Web服务器前置机来降低网络和服务器的负载，提高访问效率。</p><p>使用nginx主要的功能：反向代理(解决跨域)、负载均衡、存放静态资源。</p><h2 id="_2-linux安装nginx" tabindex="-1"><a class="header-anchor" href="#_2-linux安装nginx"><span>2.Linux安装nginx</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">tar</span> <span class="token parameter variable">-zxvf</span> nginx-1.23.1.tar.gz</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>指定Nginx进程(全局配置)所使用的用户作用：</p><ol><li>安全性：通过限制Nginx进程使用的用户，可以降低系统被攻击时受到的影响。如果Nginx进程使用的是具有较低权限的用户，攻击者在攻击Nginx时无法获取到该用户的特权，从而保护系统安全。</li><li>资源隔离：使用不同的用户运行Nginx进程可以有效隔离不同的应用程序和服务之间的资源，避免它们之间产生冲突。</li><li>维护性：使用专门的用户运行Nginx进程可以使维护人员更容易管理和维护Nginx。例如，如果需要更改Nginx进程的配置或更新Nginx的版本，管理员可以直接以该用户的身份执行相应的操作，而无需考虑其他用户的权限和影响。</li></ol><h3 id="events" tabindex="-1"><a class="header-anchor" href="#events"><span>events</span></a></h3><div class="language-conf" data-highlighter="prismjs" data-ext="conf"><pre><code class="language-conf"><span class="line">events {</span>
...
<span class="line">}</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h3 id="http" tabindex="-1"><a class="header-anchor" href="#http"><span>http</span></a></h3><div class="language-conf line-numbers-mode" data-highlighter="prismjs" data-ext="conf"><pre><code class="language-conf"><span class="line">http {</span>
...
<span class="line">}</span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>/</code></p><p><code>/index.html</code></p><p><code>/documents/document.html</code></p><p><code>/images/1.gif</code></p><p><code>/documents/1.jpg</code></p><div class="language-conf" data-highlighter="prismjs" data-ext="conf"><pre><code class="language-conf"><span class="line">location /user/ {</span>
...
<span class="line">}</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p><code>allow/deny</code> 访问控制，可以分别有多个allow,deny，允许或禁止某个ip或ip段访问，依次满足任何一个规则就停止往下匹配。</p><div class="language-conf" data-highlighter="prismjs" data-ext="conf"><pre><code class="language-conf"><span class="line">location /nginx-status {</span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>列出目录配置：</p><p>Nginx默认是不允许列出整个目录的，如需开启，在location，server或http块中加入autoindex on。</p><div class="language-conf" data-highlighter="prismjs" data-ext="conf"><pre><code class="language-conf"><span class="line">location /image {</span>
...
<span class="line">	}</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,106)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};