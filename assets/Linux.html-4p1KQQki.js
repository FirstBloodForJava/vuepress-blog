...
<span class="line"></span>
<span class="line"></span></code></pre></div><h5 id="tail" tabindex="-1"><a class="header-anchor" href="#tail"><span>tail</span></a></h5><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 输出文件的后几行</span></span>
...
<span class="line"><span class="token parameter variable">-f</span> num：显示后面多少号，不结束，有结果则继续输出</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h5 id="grep" tabindex="-1"><a class="header-anchor" href="#grep"><span>grep</span></a></h5><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">grep</span> <span class="token punctuation">[</span>option<span class="token punctuation">]</span><span class="token punctuation">..</span>. <span class="token operator">&lt;</span>file<span class="token operator">&gt;</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="du" tabindex="-1"><a class="header-anchor" href="#du"><span>du</span></a></h5><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 查看使用空间</span></span>
...
<span class="line"><span class="token parameter variable">-T</span> ：显示文件系统类型, 连同该 partition 的 filesystem 名称 <span class="token punctuation">(</span>例如 ext3<span class="token punctuation">)</span> 也列出；</span>
<span class="line"><span class="token parameter variable">-i</span> ：不用硬盘容量，而以 inode 的数量来显示</span>
<span class="line"></span></code></pre></div><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">du</span> <span class="token parameter variable">-sm</span> /*</span>
<span class="line"></span></code></pre></div><h5 id="磁盘挂载和卸载" tabindex="-1"><a class="header-anchor" href="#磁盘挂载和卸载"><span>磁盘挂载和卸载</span></a></h5><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 挂载</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://47.101.155.205/image-20250123132632881.png" alt="image-20250123132632881" tabindex="0" loading="lazy"><figcaption>image-20250123132632881</figcaption></figure><figure><img src="http://47.101.155.205/image-20250123132828966.png" alt="image-20250123132828966" tabindex="0" loading="lazy"><figcaption>image-20250123132828966</figcaption></figure><h5 id="kill" tabindex="-1"><a class="header-anchor" href="#kill"><span>kill</span></a></h5><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">kill</span> <span class="token parameter variable">-9</span> 进程id</span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="http://47.101.155.205/image-20241024165654450.png" alt="netstat -r" tabindex="0" loading="lazy"><figcaption>netstat -r</figcaption></figure><h5 id="ss" tabindex="-1"><a class="header-anchor" href="#ss"><span>ss</span></a></h5><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 命令作业与netstat类似</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><figure><img src="http://47.101.155.205/image-20241024171621727.png" alt="ss -ant" tabindex="0" loading="lazy"><figcaption>ss -ant</figcaption></figure><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 查询进程pid绑定的端口信息</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token punctuation">[</span>-b,-k,-m,-g<span class="token punctuation">]</span> <span class="token comment"># 内存单位</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><p>RAM（Random Access Memory，随机访问内存）：RAM 是系统中的高速内存，用于存储正在处理的操作系统和应用程序数据；访问速度非常快，通常在纳秒级别。</p><p>RAM 工作原理：当一个程序运行时，操作系统会将其数据加载到 RAM 中。如果 RAM 有足够的空间，所有需要的数据都会保存在 RAM 中以便快速访问。</p><p>Swap（Swap Memory，交换内存）：交换内存是系统的一部分磁盘空间，用于扩展虚拟内存；由于交换内存使用的是磁盘，其访问速度远低于 RAM，通常在毫秒级别。</p><p>Swap 工作原理：当 RAM 空间不足时，操作系统会将一些不常用的数据从 RAM 移动到交换空间，从而腾出 RAM 空间用于当前任务；这种过程称为“换出”（swap out）和“换入”（swap in）；使用交换内存会导致性能下降，因为磁盘的访问速度远低于 RAM。</p><h3 id="top" tabindex="-1"><a class="header-anchor" href="#top"><span>top</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">top</span> <span class="token punctuation">[</span>option<span class="token punctuation">]</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><figure><img src="http://47.101.155.205/image-20240606165145446.png" alt="image-20240606165145446" tabindex="0" loading="lazy"><figcaption>image-20240606165145446</figcaption></figure><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">当前时间16:29:16，运行265天6:32小时，当前登录用户数10，系统过去1分钟、5分钟、10分钟的平均负载</span>
...
<span class="line">NI：进程的nice值（影响优先级）</span>
<span class="line">VIRT：进程占用的虚拟内存总量</span>
<span class="line">RES：进程占用的物理内存总量</span>
<span class="line">SHR：进程使用的共享内存量</span>
<span class="line">S：进程状态(R:运行,S:睡眠,D:不可中断睡眠,Z:僵尸,T:停止)</span>
<span class="line">%CPU：进程消耗的CPU时间百分比</span>
<span class="line">%MEM：进程占用的物理内存百分比</span>
<span class="line">TIME+：进程运行的总CPU时间(格式mm:ss)</span>
<span class="line">COMMAND：启动进程的命令名称</span>
<span class="line"></span>
<span class="line">进入程序键盘作用</span>
<span class="line">q：退出</span>
<span class="line">P(shift+p)：按%CPU排序，默认就是</span>
<span class="line">M(shift+m)：按%MEM排序</span>
<span class="line">T(shift+T)：按TIME+排序</span>
<span class="line">1：显示所有cpu使用情况</span>
...
<span class="line"><span class="token comment"># H排序找到高cpu的进程pid</span></span>
...
<span class="line"><span class="token comment"># 查询进程pid的线程id信息,此时的id为线程nid</span></span>
