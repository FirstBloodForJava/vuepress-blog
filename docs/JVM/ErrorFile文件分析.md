...
- used：实际使用的内存。
- capacity：JVM内部已经分配好、可立即使用但尚未使用的空间。
- committed：操作系统已承诺的物理内存页。JVM向操作系统实际申请的内存大小。
- reserved：JVM为该块预留的最大虚拟地址空间。

![image-20250522164911113](http://47.101.155.205/image-20250522164911113.png)



![image-20250522165245825](http://47.101.155.205/image-20250522165245825.png)



**可以给应用开启预分配内存，避免这种情况的内存不够，导致应用停止的情况。**

![image-20250522165955616](http://47.101.155.205/image-20250522165955616.png)
